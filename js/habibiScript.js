...
var game = {
  ...
  levelLost: function() {
    ...
    timesUpDescription.innerHTML = 'You catched ' + emojiTapsCount + ' emoticons, and you had to catch '
     + gameCurrentLevel.goal + ' at least to complete this level.';
  },
  timesUp: function() {
    timeEngines.stop();
...
pauseGameButton.onclick = function() {
  ...
  gamePausedDescription.innerHTML = 'You catched ' + emojiTapsCount + ' emojis, and you have to catch '
   + gameCurrentLevel.goal + ' at least to complete this level.'
}
